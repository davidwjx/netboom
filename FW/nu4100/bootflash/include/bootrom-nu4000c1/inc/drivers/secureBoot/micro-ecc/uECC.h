...
/* Get this integration default options for uECC. */
...
/* Specifies whether compressed point format is supported.
   Set to 0 to disable point compression/decompression functions. */
    ...
    #define uECC_SUPPORT_POINT_VALIDATION 1
#else
    #define uECC_SUPPORT_POINT_VALIDATION 0
#endif

#ifdef VERIFY_ONLY
    #define uECC_VERIFY_ONLY 1
#else
    #define uECC_VERIFY_ONLY 0
#endif
...
uECC_Curve uECC_secp384r1(void);
#endif
