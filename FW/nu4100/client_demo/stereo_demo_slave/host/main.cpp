...
void Execute()
{
   ...
   inuSensorParams.GraphXmlPath = build_file_name(2, current_directory, "sw_graph_boot10065_Slave.xml");
   inuSensorParams.mHwGraphXmlPath = build_file_name(2, current_directory, "nu4100_boot10065_Slave.xml");
