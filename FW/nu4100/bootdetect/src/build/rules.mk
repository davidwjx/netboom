...
bootrom_include:
	...
	$(V)$(shell cat $(BOOTROM_BIN_PATH)/RELEASE/nu4000-rom.sym.ld | egrep -w 'board_i2c_init|get_board_info|memcpy|system_udelay|board_set_mode|board_gpp_clk_set|get_strap_info' >> nu4000-rom.sym.ld)	
	$(V)$(shell cat $(BOOTROM_BIN_PATH)/RELEASE/nu4000-rom.sym.ld | egrep -w 'GMEG_enableClk|GMEG_changeUnitFreq|GMEG_setFcuClockDiv|SPI_FLASHG_Read|SPI_FLASHG_init' >> nu4000-rom.sym.ld)	
