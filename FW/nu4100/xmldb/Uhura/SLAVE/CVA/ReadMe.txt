...
$ sudo cp <PATH_TO_>/CVA/nu4100_boot10065_CVA_b.xml /opt/Inuitive/InuDev/bin/NU4100/boot0/nu4100_boot10065_b.xml
...
./inu_sandbox -p -T Stream_Track_Stereo,s,q -T Stream_Track_Left_CVA,q -d 10000 -k 10065 -N "boot10065_b" "nu4100_boot10065_b.xml" "sw_graph_boot10065_b.xml" -T Stream_Cva_0,s,q,y,m  -B "main" "IMAGE_2" "boot10065_b" "WRITER_1" -B "main" "IMAGE_3" "boot10065_b" "WRITER_1" -J 19 800 800 -H "INU_CVA_CHANNEL_19"
