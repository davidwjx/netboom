...
extern void pm_set_registers_for_xxxx_Mbps(int freq);
extern void pm_set_rfshtmg(int freq);
extern void pm_ddrc_config_address_mapping(unsigned int col, unsigned int row, unsigned int bank);
// ==========================================================================================
...
void ddrm_umctl_init_srpd_seq(int freq) {
  ...
  pm_ddrc_config_address_mapping(DDR_COLUMN_NUM, DDR_ROW_NUM, DDR_BANK_NUM);
  ...
  pm_set_registers_for_xxxx_Mbps(freq);
  ...
  // Uri: just for cnn fdp testing - begin
  ddrm_phy_init_srpd_seq(freq);
  // Uri: just for cnn fdp testing - end  
