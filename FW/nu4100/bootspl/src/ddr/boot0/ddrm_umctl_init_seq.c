...
#define PAGE_MATCH_VALUE 0x0
#define DEFAULT_PRIORITY 0x3E0
...
unsigned int ddrm_umctl_init_seq (unsigned int freq) {
  ...
  inu_printf("\n DDR-SK Hynix configuration 27-11-23 Ver 0.91\n");  
  ...
  DDRC_INIT3_VAL = 0x0004002D;  ////sk-hynix change- old value- deafult 
...
//	debug_printf("ddrm_umctl_init_seq: DDRC_STAT_VAL = %x\n", data_val);
  ...
  // PCFGR_n Registers for 14 ports
   ...
   DDRC_MP_PCFGR_0_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_0_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_0_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_0_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_0_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_0_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_0_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_0_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_1_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_1_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_1_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_1_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_1_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_1_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_1_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_1_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_2_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_2_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_2_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_2_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_2_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_2_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_2_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_2_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_3_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_3_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_3_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_3_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_3_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_3_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_3_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_3_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_4_RD_PORT_PRIORITY_W(HIGH_PRIORITY);
   DDRC_MP_PCFGR_4_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_4_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_4_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_4_WR_PORT_PRIORITY_W(HIGH_PRIORITY);
   DDRC_MP_PCFGW_4_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_4_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_4_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_5_RD_PORT_PRIORITY_W(HIGH_PRIORITY);
   DDRC_MP_PCFGR_5_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_5_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_5_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_5_WR_PORT_PRIORITY_W(HIGH_PRIORITY);
   DDRC_MP_PCFGW_5_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_5_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_5_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_6_RD_PORT_PRIORITY_W(HIGH_PRIORITY);
   DDRC_MP_PCFGR_6_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_6_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_6_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_6_WR_PORT_PRIORITY_W(HIGH_PRIORITY);
   DDRC_MP_PCFGW_6_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_6_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_6_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_7_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_7_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_7_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_7_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_7_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_7_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_7_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_7_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_8_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_8_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_8_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_8_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_8_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_8_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_8_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_8_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_9_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_9_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_9_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_9_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_9_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_9_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_9_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_9_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_10_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_10_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_10_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_10_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_10_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_10_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_10_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_10_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_11_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_11_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_11_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_11_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_11_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_11_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_11_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_11_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_12_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_12_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_12_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_12_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_12_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_12_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_12_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_12_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------
   DDRC_MP_PCFGR_13_RD_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGR_13_RD_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGR_13_RD_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGR_13_RD_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);

   DDRC_MP_PCFGW_13_WR_PORT_PRIORITY_W(DEFAULT_PRIORITY);
   DDRC_MP_PCFGW_13_WR_PORT_AGING_EN_W(0x1);
   DDRC_MP_PCFGW_13_WR_PORT_URGENT_EN_W(0x0);
   DDRC_MP_PCFGW_13_WR_PORT_PAGEMATCH_EN_W(PAGE_MATCH_VALUE);
  //-------------------------------------------

   // TBD: ports 12&13 have to configure under IAU clock, it done on inu_target.out
   ...
   DDRC_MP_PCFGQOS0_7_RQOS_MAP_LEVEL1_W(0xE);  // enlarge region 0
   DDRC_MP_PCFGQOS0_7_RQOS_MAP_REGION0_W(0x0); // LPR
   DDRC_MP_PCFGQOS0_7_RQOS_MAP_REGION1_W(0x0); // LPR
   //DDRC_MP_PCFGQOS0_8_RQOS_MAP_LEVEL1_W(0xE);  // enlarge region 0
   //DDRC_MP_PCFGQOS0_8_RQOS_MAP_REGION0_W(0x0); // LPR
   //DDRC_MP_PCFGQOS0_8_RQOS_MAP_REGION1_W(0x0); // LPR
   DDRC_MP_PCFGQOS0_9_RQOS_MAP_LEVEL1_W(0xE);  // enlarge region 0
   DDRC_MP_PCFGQOS0_9_RQOS_MAP_REGION0_W(0x0); // LPR
   DDRC_MP_PCFGQOS0_9_RQOS_MAP_REGION1_W(0x0); // LPR
   DDRC_MP_PCFGQOS0_10_RQOS_MAP_LEVEL1_W(0xE);  // enlarge region 0
   DDRC_MP_PCFGQOS0_10_RQOS_MAP_REGION0_W(0x0); // LPR
   DDRC_MP_PCFGQOS0_10_RQOS_MAP_REGION1_W(0x0); // LPR
  ...
  DDRC_MP_PCCFG_VAL = 0x00000011; // bl_exp_mode=0, pagematch_limit=0, go2critical_en=1
...
static void set_registers_for_xxxx_Mbps (unsigned int freq) {
  ...
  // SDRAM Timing Registers
  //                  wr2pre[30:24] | t_faw[21:16] | t_ras_max[14:8] | t_ras_min[5:0]
  DDRC_DRAMTMG0_VAL = ((0x1a << 24) | (0x1d << 16) | (0x18 << 8)     | (0x1e << 0));     //sky-hynix change- old value: (0x19 << 24) | (0x1d << 16) | (0x18 << 8)     | (0x1e << 0)
#ifdef __DDR_RFSH_ALL_BANKS
...
#endif
  DDRC_DRAMTMG2_VAL = 0x070e1114; //0x070e1213 //07101413//0x070e1113 
