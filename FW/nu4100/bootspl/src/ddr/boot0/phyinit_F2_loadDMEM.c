...
dwc_ddrphy_apb_wr_d(0x00006,0x14);                         // {Lp4Misc, PhyVref}
#endif
dwc_ddrphy_apb_wr_d(0x00007,0x0000);                       // {CsTestFail, Reserved0E}
dwc_ddrphy_apb_wr_d(0x00008,0x61);                         // SequenceCtrl
...
dwc_ddrphy_apb_wr_d(0x0000c,0x0);                          // {Reserved19, UseBroadcastMR}
dwc_ddrphy_apb_wr_d(0x0000d,0x01aa);                       // {CATrainOpt, Reserved1A}
dwc_ddrphy_apb_wr_d(0x0000e,0x2100);                          // {RX2D_TrainOpt, X8Mode}
dwc_ddrphy_apb_wr_d(0x0000f,0x1021);                        // {Share2DVrefResult, TX2D_TrainOpt}
dwc_ddrphy_apb_wr_d(0x00010,0x8020);                       // {Voltage_Weight2D, Delay_Weight2D}
...
dwc_ddrphy_apb_wr_d(0x0001b,0x6665);                       // 0x6d {MR12_A0, MR11_A0}
...
dwc_ddrphy_apb_wr_d(0x00026,0x0);                          // {TrainedVREFDQ_A0, Reserved4C}
dwc_ddrphy_apb_wr_d(0x00027,0x0);                          // {RxClkDly_Margin_A0, TrainedVREFDQ_A1}
dwc_ddrphy_apb_wr_d(0x00028,0x0);                          // {TxDqDly_Margin_A0, VrefDac_Margin_A0}
dwc_ddrphy_apb_wr_d(0x00029,0x0);                          // {RxClkDly_Margin_A1, DeviceVref_Margin_A0}
dwc_ddrphy_apb_wr_d(0x0002a,0x0);                          // {TxDqDly_Margin_A1, VrefDac_Margin_A1}
...
dwc_ddrphy_apb_wr_d(0x00035,0x2a66);                       // {MR13_B0, MR12_B0}
dwc_ddrphy_apb_wr_d(0x00036,0x4d);                         // {MR16_B0, MR14_B0}
dwc_ddrphy_apb_wr_d(0x00037,0x500);                        // {MR22_B0, MR17_B0}
...
dwc_ddrphy_apb_wr_d(0x00205,0x0);
dwc_ddrphy_apb_wr_d(0x00206,0x0);
dwc_ddrphy_apb_wr_d(0x00207,0x0);
dwc_ddrphy_apb_wr_d(0x00208,0x0);
dwc_ddrphy_apb_wr_d(0x00209,0x0);
dwc_ddrphy_apb_wr_d(0x0020a,0x14a);
dwc_ddrphy_apb_wr_d(0x0020b,0x181);
dwc_ddrphy_apb_wr_d(0x0020c,0x118);
dwc_ddrphy_apb_wr_d(0x0020d,0x118);
dwc_ddrphy_apb_wr_d(0x0020e,0x16f);
dwc_ddrphy_apb_wr_d(0x0020f,0x16f);
dwc_ddrphy_apb_wr_d(0x00210,0x159);
dwc_ddrphy_apb_wr_d(0x00211,0x181);
dwc_ddrphy_apb_wr_d(0x00212,0x120);
dwc_ddrphy_apb_wr_d(0x00213,0x120);
dwc_ddrphy_apb_wr_d(0x00214,0x0);
dwc_ddrphy_apb_wr_d(0x00215,0x0);
dwc_ddrphy_apb_wr_d(0x00216,0x701c);
dwc_ddrphy_apb_wr_d(0x00217,0x61a8);
dwc_ddrphy_apb_wr_d(0x00218,0x35ac);
dwc_ddrphy_apb_wr_d(0x00219,0x35ac);
dwc_ddrphy_apb_wr_d(0x0021a,0x125c);
dwc_ddrphy_apb_wr_d(0x0021b,0x125c);
dwc_ddrphy_apb_wr_d(0x0021c,0xc738);
dwc_ddrphy_apb_wr_d(0x0021d,0xb0f4);
dwc_ddrphy_apb_wr_d(0x0021e,0x6590);
dwc_ddrphy_apb_wr_d(0x0021f,0x6590);
dwc_ddrphy_apb_wr_d(0x00220,0x0);
dwc_ddrphy_apb_wr_d(0x00221,0x0);
dwc_ddrphy_apb_wr_d(0x00222,0x0);
dwc_ddrphy_apb_wr_d(0x00223,0x0);
dwc_ddrphy_apb_wr_d(0x00224,0x2e9e);
dwc_ddrphy_apb_wr_d(0x00225,0x33);
dwc_ddrphy_apb_wr_d(0x00226,0x0);
dwc_ddrphy_apb_wr_d(0x00227,0x0);
dwc_ddrphy_apb_wr_d(0x00228,0x321e);
dwc_ddrphy_apb_wr_d(0x00229,0x100);
dwc_ddrphy_apb_wr_d(0x0022a,0x0);
dwc_ddrphy_apb_wr_d(0x0022b,0x0);
dwc_ddrphy_apb_wr_d(0x0022c,0x100);
dwc_ddrphy_apb_wr_d(0x0022d,0x302);
dwc_ddrphy_apb_wr_d(0x0022e,0x706);
dwc_ddrphy_apb_wr_d(0x0022f,0xb0a);
dwc_ddrphy_apb_wr_d(0x00230,0xf0e);
dwc_ddrphy_apb_wr_d(0x00231,0x1b1a);
dwc_ddrphy_apb_wr_d(0x00232,0x1f1e);
dwc_ddrphy_apb_wr_d(0x00233,0x3b3a);
dwc_ddrphy_apb_wr_d(0x00234,0x3f3e);
dwc_ddrphy_apb_wr_d(0x00235,0x0);
dwc_ddrphy_apb_wr_d(0x00236,0xffff);
dwc_ddrphy_apb_wr_d(0x00237,0x1e0);
dwc_ddrphy_apb_wr_d(0x00238,0xf0);
dwc_ddrphy_apb_wr_d(0x00239,0xa0);
dwc_ddrphy_apb_wr_d(0x0023a,0x78);
dwc_ddrphy_apb_wr_d(0x0023b,0x60);
dwc_ddrphy_apb_wr_d(0x0023c,0x50);
dwc_ddrphy_apb_wr_d(0x0023d,0x43);
dwc_ddrphy_apb_wr_d(0x0023e,0x3c);
dwc_ddrphy_apb_wr_d(0x0023f,0x35);
dwc_ddrphy_apb_wr_d(0x00240,0x30);
dwc_ddrphy_apb_wr_d(0x00241,0x2c);
dwc_ddrphy_apb_wr_d(0x00242,0x28);
dwc_ddrphy_apb_wr_d(0x00243,0x25);
dwc_ddrphy_apb_wr_d(0x00244,0x22);
dwc_ddrphy_apb_wr_d(0x00245,0x20);
dwc_ddrphy_apb_wr_d(0x00246,0x1e);
dwc_ddrphy_apb_wr_d(0x00247,0x1c);
dwc_ddrphy_apb_wr_d(0x00248,0x0);
dwc_ddrphy_apb_wr_d(0x00249,0x0);
dwc_ddrphy_apb_wr_d(0x0024a,0x0);
dwc_ddrphy_apb_wr_d(0x0024b,0x0);
dwc_ddrphy_apb_wr_d(0x0024c,0x0);
dwc_ddrphy_apb_wr_d(0x0024d,0x0);
dwc_ddrphy_apb_wr_d(0x0024e,0x0);
dwc_ddrphy_apb_wr_d(0x0024f,0x0);
dwc_ddrphy_apb_wr_d(0x00250,0x2820);
dwc_ddrphy_apb_wr_d(0x00251,0x140f);
dwc_ddrphy_apb_wr_d(0x00252,0x2);
dwc_ddrphy_apb_wr_d(0x00253,0x0);
dwc_ddrphy_apb_wr_d(0x00254,0xf01f);
dwc_ddrphy_apb_wr_d(0x00255,0x1);
dwc_ddrphy_apb_wr_d(0x00256,0x0);
dwc_ddrphy_apb_wr_d(0x00257,0xffb4);
dwc_ddrphy_apb_wr_d(0x00258,0x1);
dwc_ddrphy_apb_wr_d(0x00259,0x1);
dwc_ddrphy_apb_wr_d(0x0025a,0xf0b4);
dwc_ddrphy_apb_wr_d(0x0025b,0x1);
dwc_ddrphy_apb_wr_d(0x0025c,0x0);
dwc_ddrphy_apb_wr_d(0x0025d,0xf4b4);
dwc_ddrphy_apb_wr_d(0x0025e,0x1);
dwc_ddrphy_apb_wr_d(0x0025f,0x0);
dwc_ddrphy_apb_wr_d(0x00260,0xf0b9);
dwc_ddrphy_apb_wr_d(0x00261,0x1);
dwc_ddrphy_apb_wr_d(0x00262,0x0);
dwc_ddrphy_apb_wr_d(0x00263,0xf0ba);
dwc_ddrphy_apb_wr_d(0x00264,0x1);
dwc_ddrphy_apb_wr_d(0x00265,0x0);
dwc_ddrphy_apb_wr_d(0x00266,0xf0bb);
dwc_ddrphy_apb_wr_d(0x00267,0x1);
dwc_ddrphy_apb_wr_d(0x00268,0x0);
dwc_ddrphy_apb_wr_d(0x00269,0xf001);
dwc_ddrphy_apb_wr_d(0x0026a,0x1);
dwc_ddrphy_apb_wr_d(0x0026b,0x0);
dwc_ddrphy_apb_wr_d(0x0026c,0xf013);
dwc_ddrphy_apb_wr_d(0x0026d,0x1);
dwc_ddrphy_apb_wr_d(0x0026e,0x0);
dwc_ddrphy_apb_wr_d(0x0026f,0xf0f9);
dwc_ddrphy_apb_wr_d(0x00270,0x4);
dwc_ddrphy_apb_wr_d(0x00271,0x200);
dwc_ddrphy_apb_wr_d(0x00272,0xf0fa);
dwc_ddrphy_apb_wr_d(0x00273,0x4);
dwc_ddrphy_apb_wr_d(0x00274,0x0);
dwc_ddrphy_apb_wr_d(0x00275,0xf0fb);
dwc_ddrphy_apb_wr_d(0x00276,0x4);
dwc_ddrphy_apb_wr_d(0x00277,0x400);
dwc_ddrphy_apb_wr_d(0x00278,0xf060);
dwc_ddrphy_apb_wr_d(0x00279,0x7);
dwc_ddrphy_apb_wr_d(0x0027a,0x8);
dwc_ddrphy_apb_wr_d(0x0027b,0xf065);
dwc_ddrphy_apb_wr_d(0x0027c,0x7);
dwc_ddrphy_apb_wr_d(0x0027d,0x0);
dwc_ddrphy_apb_wr_d(0x0027e,0xff62);
dwc_ddrphy_apb_wr_d(0x0027f,0x1);
dwc_ddrphy_apb_wr_d(0x00280,0x0);
dwc_ddrphy_apb_wr_d(0x00281,0xf002);
dwc_ddrphy_apb_wr_d(0x00282,0x1);
dwc_ddrphy_apb_wr_d(0x00283,0x220);
dwc_ddrphy_apb_wr_d(0x00284,0x10f8);
dwc_ddrphy_apb_wr_d(0x00285,0x20e8);
dwc_ddrphy_apb_wr_d(0x00286,0xa06);
dwc_ddrphy_apb_wr_d(0x00287,0x140e);
dwc_ddrphy_apb_wr_d(0x00288,0x1c18);
dwc_ddrphy_apb_wr_d(0x00289,0x2420);
dwc_ddrphy_apb_wr_d(0x0028a,0xc06);
dwc_ddrphy_apb_wr_d(0x0028b,0x1610);
dwc_ddrphy_apb_wr_d(0x0028c,0x201c);
dwc_ddrphy_apb_wr_d(0x0028d,0x2824);
dwc_ddrphy_apb_wr_d(0x0028e,0xa06);
dwc_ddrphy_apb_wr_d(0x0028f,0x1610);
dwc_ddrphy_apb_wr_d(0x00290,0x201a);
dwc_ddrphy_apb_wr_d(0x00291,0x2824);
dwc_ddrphy_apb_wr_d(0x00292,0xc06);
dwc_ddrphy_apb_wr_d(0x00293,0x1812);
dwc_ddrphy_apb_wr_d(0x00294,0x241e);
dwc_ddrphy_apb_wr_d(0x00295,0x2c28);
dwc_ddrphy_apb_wr_d(0x00296,0x20d);
dwc_ddrphy_apb_wr_d(0x00297,0x301);
dwc_ddrphy_apb_wr_d(0x00298,0xc0b);
dwc_ddrphy_apb_wr_d(0x00299,0x160e);
dwc_ddrphy_apb_wr_d(0x0029a,0x1004);
dwc_ddrphy_apb_wr_d(0x0029b,0x1811);
dwc_ddrphy_apb_wr_d(0x0029c,0x6e);
dwc_ddrphy_apb_wr_d(0x0029d,0x2);
dwc_ddrphy_apb_wr_d(0x0029e,0x1);
dwc_ddrphy_apb_wr_d(0x0029f,0xfd);
dwc_ddrphy_apb_wr_d(0x002a0,0x4);
dwc_ddrphy_apb_wr_d(0x002a1,0xf);
dwc_ddrphy_apb_wr_d(0x002a2,0x60);
dwc_ddrphy_apb_wr_d(0x002a3,0x7);
dwc_ddrphy_apb_wr_d(0x002a4,0x0);
dwc_ddrphy_apb_wr_d(0x002a5,0xe8);
dwc_ddrphy_apb_wr_d(0x002a6,0x4);
dwc_ddrphy_apb_wr_d(0x002a7,0xff);
dwc_ddrphy_apb_wr_d(0x002a8,0xfc);
dwc_ddrphy_apb_wr_d(0x002a9,0x4);
dwc_ddrphy_apb_wr_d(0x002aa,0x404);
dwc_ddrphy_apb_wr_d(0x002ab,0x3a);
dwc_ddrphy_apb_wr_d(0x002ac,0x2);
dwc_ddrphy_apb_wr_d(0x002ad,0x2);
dwc_ddrphy_apb_wr_d(0x002ae,0x11);
dwc_ddrphy_apb_wr_d(0x002af,0x7);
dwc_ddrphy_apb_wr_d(0x002b0,0x0);
dwc_ddrphy_apb_wr_d(0x002b1,0x0);
// // [dwc_ddrphy_phyinit_WriteOutMem] DONE.  Index 0x2b2
