...
dwc_ddrphy_apb_wr(0x1005f,0x188); // DWC_DDRPHYA_DBYTE0_TxSlewRate_b0_p0
dwc_ddrphy_apb_wr(0x1015f,0x188); // DWC_DDRPHYA_DBYTE0_TxSlewRate_b1_p0
dwc_ddrphy_apb_wr(0x1105f,0x188); // DWC_DDRPHYA_DBYTE1_TxSlewRate_b0_p0
dwc_ddrphy_apb_wr(0x1115f,0x188); // DWC_DDRPHYA_DBYTE1_TxSlewRate_b1_p0
dwc_ddrphy_apb_wr(0x1205f,0x188); // DWC_DDRPHYA_DBYTE2_TxSlewRate_b0_p0
dwc_ddrphy_apb_wr(0x1215f,0x188); // DWC_DDRPHYA_DBYTE2_TxSlewRate_b1_p0
dwc_ddrphy_apb_wr(0x1305f,0x188); // DWC_DDRPHYA_DBYTE3_TxSlewRate_b0_p0
dwc_ddrphy_apb_wr(0x1315f,0x188); // DWC_DDRPHYA_DBYTE3_TxSlewRate_b1_p0
...
dwc_ddrphy_apb_wr(0x20024,0x1e3); // DWC_DDRPHYA_MASTER0_DqsPreambleControl_p0
...
#ifndef _ZEBU
DDRP_DBYTE0_DQ0LNSEL_VAL = 1;
DDRP_DBYTE0_DQ1LNSEL_VAL = 2;
DDRP_DBYTE0_DQ2LNSEL_VAL = 3;
DDRP_DBYTE0_DQ3LNSEL_VAL = 4;
DDRP_DBYTE0_DQ4LNSEL_VAL = 0;
DDRP_DBYTE0_DQ5LNSEL_VAL = 5;
DDRP_DBYTE0_DQ6LNSEL_VAL = 6;
DDRP_DBYTE0_DQ7LNSEL_VAL = 7;

DDRP_DBYTE1_DQ0LNSEL_VAL = 6;
DDRP_DBYTE1_DQ1LNSEL_VAL = 7;
DDRP_DBYTE1_DQ2LNSEL_VAL = 0;
DDRP_DBYTE1_DQ3LNSEL_VAL = 5;
DDRP_DBYTE1_DQ4LNSEL_VAL = 1;
DDRP_DBYTE1_DQ5LNSEL_VAL = 2;
DDRP_DBYTE1_DQ6LNSEL_VAL = 4;
DDRP_DBYTE1_DQ7LNSEL_VAL = 3;

DDRP_DBYTE2_DQ0LNSEL_VAL = 6;
DDRP_DBYTE2_DQ1LNSEL_VAL = 7;
DDRP_DBYTE2_DQ2LNSEL_VAL = 2;
DDRP_DBYTE2_DQ3LNSEL_VAL = 1;
DDRP_DBYTE2_DQ4LNSEL_VAL = 0;
DDRP_DBYTE2_DQ5LNSEL_VAL = 5;
DDRP_DBYTE2_DQ6LNSEL_VAL = 4;
DDRP_DBYTE2_DQ7LNSEL_VAL = 3;
#define __DDR_SMALL_BOARD
#ifndef __DDR_SMALL_BOARD
DDRP_DBYTE3_DQ0LNSEL_VAL = 6;
DDRP_DBYTE3_DQ1LNSEL_VAL = 1;
DDRP_DBYTE3_DQ2LNSEL_VAL = 0;  // SVB
DDRP_DBYTE3_DQ3LNSEL_VAL = 7;
DDRP_DBYTE3_DQ4LNSEL_VAL = 5;
DDRP_DBYTE3_DQ5LNSEL_VAL = 4;
DDRP_DBYTE3_DQ6LNSEL_VAL = 3;
DDRP_DBYTE3_DQ7LNSEL_VAL = 2;
#else
DDRP_DBYTE3_DQ0LNSEL_VAL = 1;
DDRP_DBYTE3_DQ1LNSEL_VAL = 4;
DDRP_DBYTE3_DQ2LNSEL_VAL = 0;
DDRP_DBYTE3_DQ3LNSEL_VAL = 7;  //REGULAR
DDRP_DBYTE3_DQ4LNSEL_VAL = 2;
DDRP_DBYTE3_DQ5LNSEL_VAL = 3;
DDRP_DBYTE3_DQ6LNSEL_VAL = 5;
DDRP_DBYTE3_DQ7LNSEL_VAL = 6;
#endif
#endif //_ZEBU
