...
dwc_ddrphy_apb_wr_d(0x0000d,0x0100);                       // {CATrainOpt, Reserved1A}
dwc_ddrphy_apb_wr_d(0x0000e,0x0);                          // {RX2D_TrainOpt, X8Mode}
dwc_ddrphy_apb_wr_d(0x0000f,0x100);                        // {Share2DVrefResult, TX2D_TrainOpt}
