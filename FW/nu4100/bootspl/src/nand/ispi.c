...
/****************************************************************************
*
*  Function Name: SPI_NAND_DRVG_spiTransaction
*
*  Description:
*
*  Inputs:
...
*
****************************************************************************/
UINT32 SPI_DRVG_spiTransaction_(BYTE *pTxBuffer, UINT32 txLen, BYTE *pRxBuffer, UINT32 rxLen, unsigned long flags )
{
   UINT32   retVal = SPI_SUCCESS;
   UINT32 xmt_count = 0;
   UINT32 itrNum = 0;
...
/****************************************************************************
*
*  Function Name: SPI_NAND_DRVG_close
*
*  Description:
*
*  Inputs:
