 ...
 ****************************************************************************/
#define SB_CONFIDENTIALITY_BYTES    (SBIF_CFG_CONFIDENTIALITY_BITS/8)   //Ksbcr is 128 bit
...
#define SB_ECDSA_BYTES              ((SBIF_CFG_ECDSA_BITS*2)/8)         //Kpublic is 256*2 bit
