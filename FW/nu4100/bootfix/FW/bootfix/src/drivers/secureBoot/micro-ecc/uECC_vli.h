...
/* Computes left = left + right, returning carry. Always modifies in place. */
...
/* Computes left = left - right, returning borrow. Always modify in place. */
uECC_word_t uECC_vli_accumulate_neg(uECC_word_t *result,
                         const uECC_word_t *left,
                         const uECC_word_t *right,
                         wordcount_t num_words);
