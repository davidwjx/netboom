...
void GMEG_initUsbPhyParam(void)
{
   ...
   GME_PHY_PARAM_0_COMPDISTUNE0_W(3);
   GME_PHY_PARAM_0_OTGTUNE0_W(3);
   ...
   // Tunning
   //GME_PHY_PARAM_1_SQRXTUNE0_W(0);
   //GME_PHY_PARAM_1_TXFSLSTUNE0_W(15);
   //GME_PHY_PARAM_0_COMPDISTUNE0_W(0);
   //GME_PHY_PARAM_0_OTGTUNE0_W(3);
   //GME_PHY_PARAM_0_PCS_TX_DEEMPH_3P5DB_W(60);

   // Must
   GME_PHY_PARAM_2_LOS_BIAS_W(2);

   //GME_PHY_PARAM_2_SSC_RANGE_W(2);
}
