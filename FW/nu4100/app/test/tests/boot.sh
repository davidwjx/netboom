...
LD_LIBRARY_PATH=$TMP_DIR/bin $TMP_DIR/bin/inu_usb_wait 30 $TMP_DIR/boot
#LD_LIBRARY_PATH=$param_bindir/$param_platform $param_bindir/$param_platform/inu_usb_wait 30 $param_boot 
