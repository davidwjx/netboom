...
typedef enum CamerIcIspStitchingCombinationMode_e {
	...
	CAMERIC_ISP_STITCHING_LINEAR_COMBINE = 1,	    /**< linear L+S and LV+VS*/
	CAMERIC_ISP_STITCHING_NONLINEAR_COMBINE = 2,	    /**< nonlinear L+S */
	CAMERIC_ISP_STITCHING_LINEAR_NONLINEAR_COMBINE = 3, /**< linear L+S and nonlinear LS+VS */
...
typedef enum CamercIcIspStitchingFrame_e {
	CAMERIC_ISP_STITCHING_LONG_FRAME = 0,
	CAMERIC_ISP_STITCHING_SHORT_FRAME = 1,
	CAMERIC_ISP_STITCHING_VERY_SHORT_FRAME = 2,
	CAMERIC_ISP_STITCHING_FRAME_MAX,
} CamercIcIspStitchingFrame_t;
...
typedef enum CamerIcIspStitchingHdrMode_e {
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_INVALID = 0,		/**< lower border (only for an internal evaluation) */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_3DOL_DUAL_DCG = 1,	/**< dual DCG mode 3x12-bit */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_3DOL = 2,			/**< dol3 frame 3x12-bit */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_3DOL_LINEBYLINE = 3,	/**< 3x12-bit line by line without waiting */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_2DOL_16BIT_COMPRESS = 4,	/**< 16-bit compressed data + 12-bit RAW */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_2DOL_DUAL_DCG_NOWAIT = 5, /**< 2x12-bit dual DCG without waiting */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_2DOL_L_VS = 6,		/**< dol2 frame or 1 CG+VS sx12-bit RAW */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_2DOL_L_S = 7,		/**< L+S 2x12-bit RAW */
	CAMERIC_ISP_STITCHING_SENSOR_HDR_MODE_MAX			/**< upper border (only for an internal evaluation) */
...
*
* @brief   configue stitching properties
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   get stitching black level
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   set stitching black level
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   get STITCHING Module awb gain
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   set STITCHING Module awb gain
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   set STITCHING Module linear trans range
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   set STITCHING Module non-linear trans range
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   set STITCHING Module L and S Ratio
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   set STITCHING Module VS Ratio
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   Set STITCHING Module compress Lut table
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   Get STITCHING Module external bit
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   Set STITCHING Module external bit
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
/*****************************************************************************/
/**
*          CamerIcIspStitchingDigitalGainSet()
*
* @brief   Set STITCHING Module digital gain
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   Set STITCHING Module VS parameters
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   Set STITCHING Module LS parameters
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
*
* @brief   Set STITCHING Module color weight
*
* @param   handle          CamerIc driver handle
*
* @return                  Return the result of the function call.
...
/*****************************************************************************/
/**
 *          CamerIcIspStitchingIsEnabled()
 *
 * @brief   is stitching enabled
 *
 * @param   handle          CamerIc driver handle
 *
 * @return                  Return the result of the function call.
...
/*****************************************************************************/
/**
 *          CamerIcIspStitchingHdrMode()
 *
 * @brief   get sensor hdr mode
 *
 * @param   handle          CamerIc driver handle
 *
 * @return                  Return the result of the function call.
