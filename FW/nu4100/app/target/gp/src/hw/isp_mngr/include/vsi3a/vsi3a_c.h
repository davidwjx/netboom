 ...
 *      we need create instance for each isp.
 */
VVEXPORTS Vsi3AHandle_t Vsi3ACreateInstanceWithFile(int ispId, const char* filename);
...
/** @brief set 3A metadata
 * @param type, in vsi3a_types.h, VSI_AE_MODE, VSI_AF_MODE, VSI_AWB_MODE
 *  @param Vsi3AMetaData, in vsi3a_types.h  Get left camera data of awb/ae
 */
VVEXPORTS int Vsi3AGetMetaData(Vsi3AHandle_t handle, struct Vsi3AMetaData *metadata);

/** @brief set 3A metadata
 * @param type, in vsi3a_types.h, VSI_AE_MODE, VSI_AF_MODE, VSI_AWB_MODE
 *  @param Vsi3AMetaData, in vsi3a_types.h  sync left camera data to right camera
 */
VVEXPORTS int Vsi3ASetMetaData(Vsi3AHandle_t handle, struct Vsi3AMetaData *metadata);
