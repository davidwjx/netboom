...
typedef struct CamEngineConfig_s
{
    ...
    union CamEngineConfigData_u
    {
        struct CamEngineConfigSensor_s
        {
            ...
            CamEngineWindow_t               cropWindow[CAM_ENGINE_PATH_SELF2_BP+1];
...
enum CAMENG_WORK_MODE {

	CAMENG_STREAM_MODE=0,
	CAMENG_MCM_MODE,
	CAMENG_TILE_MODE,
	CAMENG_RDMA_MODE,
	CAMENG_NO_CONFIG
...
/*****************************************************************************/
/**
 * @brief   This function load image.
 *
 * @param   hCamEngine      Handle to the CamEngine instance.
 * @param   pPicbuff        the image addr.
 *
 * @return  Return the result of the function call.
 * @retval  RET_SUCCESS         function succeed
 * @retval  RET_WRONG_HANDLE    invalid instance handle
 ...
 *
 *****************************************************************************/
RESULT CamEngineLoadimage
(
	CamEngineHandle_t	hCamEngine,
	MediaBuffer_t* pPicbuff
);


/*****************************************************************************/
/**
 * @brief   This function Get the buffer pool of the corresponding BUFIO_ID.
 *
 * @param   hCamEngine           Handle to the CamEngine instance.
 * @param   ISPCORE_BUFIO_ID     channel id.
 * @param   MediaBufPool_t     	 buf_pool ptr.
 *
 * @return  Return the result of the function call.
 * @retval  RET_SUCCESS         function succeed
 * @retval  RET_WRONG_HANDLE    invalid instance handle
 ...
 *
 *****************************************************************************/
RESULT CamEngineGetMediaBufPool
(
	CamEngineHandle_t	hCamEngine,
	ISPCORE_BUFIO_ID chain,
	MediaBufPool_t **pbufpool
);
