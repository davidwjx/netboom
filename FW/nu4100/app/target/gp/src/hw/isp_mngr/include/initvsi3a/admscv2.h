...
|*                                                                            *|
\******************************************************************************/
#ifndef VSI_3AV2_ADMSCV2_H_
#define VSI_3AV2_ADMSCV2_H_

#include <BaseAuto.h>


namespace vsi3av2 {
class ADmscv2 : public BaseAuto {
...
private:
    ...
    typedef struct AutoTable {
        vector<float> sharpen_enable;
        vector<float> depurple_enable;
        vector<float> gain;
        ...
        vector<float> r2;
        vector<float> r3;
        vector<float> sat_shrink;
        vector<float> cbcr_mode;
        vector<float> depurple_thr;
    } AutoTable;
