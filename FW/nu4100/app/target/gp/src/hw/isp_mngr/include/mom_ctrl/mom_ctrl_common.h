...
enum MomCtrlPool_e
{
    MOM_CTRL_SMALL_POOL                  = 0,
    MOM_CTRL_LARGE_POOL                  = 1,
    MOM_CTRL_POOL_MAX
};

enum MomCtrlPath_e
{
    MOM_CTRL_PATH_MAIN                  = 0,
    MOM_CTRL_PATH_SELF                  = 1,
    MOM_CTRL_PATH_SELF2                 = 2,
    MOM_CTRL_PATH_MCM_WR0               ,
    MOM_CTRL_PATH_MCM_WR1               ,
    MOM_CTRL_PATH_MCM_WR2               ,
    MOM_CTRL_PATH_MCM_WR3               ,
...
enum MomCtrlCommand_e
{
    ...
    MOM_CTRL_CMD_PROC_FULL_BUFFER_MCM_WR2_PATH ,
    MOM_CTRL_CMD_PROC_FULL_BUFFER_MCM_WR3_PATH ,
#ifdef ISP_MI_PP_WRITE
