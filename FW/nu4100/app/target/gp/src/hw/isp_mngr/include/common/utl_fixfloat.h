...
//static int clip(int32_t value, int32_t min, int32_t max);
unsigned interp1(unsigned *lut_x, unsigned * lut_y, unsigned px_in, int lut_size, int y_bit_width);

double forward(double a, double b, int val);
double backward(double a, double s, double val);
