 ...
 * @param   pConfig             pointer to the config context @ref CamerIcCprocConfig_t
...
/*****************************************************************************/
/**
 * @brief   This function return configuration of the CamerIC CPROC Module.
 *
 * @param   handle              CamerIc driver handle
 * @param   pConfig             pointer to the configuration
 * @param   pRunning            pointer to the running status.
 ...
 *
 *****************************************************************************/
extern RESULT CamerIcCprocGetConfigure
(
    CamerIcDrvHandle_t      handle,
    CamerIcCprocConfig_t    *pConfig,
    bool_t *pRunning
