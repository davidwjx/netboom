...
|*                                                                            *|
\******************************************************************************/
#ifndef VSI_3AV2_AEEV1_H_
#define VSI_3AV2_AEEV1_H_

#include <BaseAuto.h>

namespace vsi3av2 {
class Aeev1 : public BaseAuto {
...
private:
    ...
    typedef struct AutoTable {
        ...
        vector<float> enableCA;
        vector<float> enableDCI;
        vector<vector<float>> curveCA;
        vector<vector<float>> curveDCI;
    } AutoTable;
