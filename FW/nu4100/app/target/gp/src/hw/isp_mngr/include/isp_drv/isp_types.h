...
enum {
	IC_MI_PIXEL_YUV_BIT_INVALID = -1, /**< lower border (only for an internal evaluation) */
	IC_MI_PIXEL_YUV_8_BIT = 0,	       /**< The value of yuv pixel is 8 bit. */
	IC_MI_PIXEL_YUV_10_BIT = 1,       /**< The value of yuv pixel is 10 bit.*/
	IC_MI_PIXEL_YUV_12_BIT = 2,       /**< The value of yuv pixel is 12 bit.*/
	IC_MI_PIXEL_YUV_BIT_MAX	       /**< upper border (only for an internal evaluation) */
};
enum {
...
enum {
	...
	ISP_MI_DATA_ALIGN_DOUBLE_WORD = 1, /* yuv pixel data double word aligned. */
	ISP_MI_DATA_ALIGN_WORD = 2,	   /**< The value of yuv pixel is  word align.*/
	ISP_MI_DATA_ALIGN_16BIT_MODE = 2, /* raw pixel data  aligned with 16 bit. */
