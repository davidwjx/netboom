...
public:
   ...
   *
   */
  ClientHolder(ClientHolder const &) = delete;

  /**
   * @brief Destroy the Client Holder object
   *
   */
  ~ClientHolder();
   ...
   * @return ClientHolder&
   */
  ClientHolder &operator=(ClientHolder const &) = delete;
   ...
   * @return ClientHolder&
   */
  ClientHolder &request(Json::Value const &jQuery,
