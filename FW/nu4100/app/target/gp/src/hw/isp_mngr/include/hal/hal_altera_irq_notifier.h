...
typedef enum HalIrqNotifierCmdId_e
{
    ...
    HAL_IRQ_NORIFIER_CMD_REGISTER_MI3_IRQ           ,    /**< register mi3 irq command  */
    HAL_IRQ_NORIFIER_CMD_REGISTER_MIPI_IRQ          ,    /**< register mipi irq command  */
    HAL_IRQ_NORIFIER_CMD_REGISTER_ISP_STITCHING_IRQ ,    /**< register mi stitch irq command  */
    HAL_IRQ_NORIFIER_CMD_REGISTER_MI_HDR1_IRQ       ,    /**< register mi hdr1 irq command  */
    ...
    HAL_IRQ_NORIFIER_CMD_UNREGISTER_MI3_IRQ,
    HAL_IRQ_NORIFIER_CMD_UNREGISTER_MIPI_IRQ,
    HAL_IRQ_NORIFIER_CMD_UNREGISTER_ISP_STITCHING_IRQ,
    HAL_IRQ_NORIFIER_CMD_UNREGISTER_MI_HDR1_IRQ,
