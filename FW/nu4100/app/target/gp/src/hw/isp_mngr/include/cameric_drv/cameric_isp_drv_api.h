...
/*****************************************************************************/
/**
 * @brief   This function configures the CamerIC ISP Mcm write.
 *
 * @param   handle              CamerIC driver handle
 * @param   width               mcm write width
 * @param   height              mcm write height
 * @param   format              mcm write format
 * @param   path                mcm write path
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 *
 *****************************************************************************/
RESULT CamerIcIspCfgMcmWr
(
    CamerIcDrvHandle_t              handle,
    uint16_t width,
    uint16_t height,
...
/*****************************************************************************/
/**
 * @brief   This function configures the CamerIC ISP Mcm g2 channel write .
 *
 * @param   handle              CamerIC driver handle
 * @param   width               mcm g2 channel write width
 * @param   height              mcm g2 channel write height
 * @param   format              mcm g2 channel write format
 * @param   path                mcm g2 channel write path
 * @return                      Return the result of the function call.
 * @retval  RET_SUCCESS         operation succeded
 * @retval  RET_FAILURE         common error occured
 *
 *****************************************************************************/
RESULT CamerIcIspCfgMcmG2Wr
(
    CamerIcDrvHandle_t              handle,
    uint16_t width,
    uint16_t height,
 ...
 * @param   stitchingMode        stitching work mode.
 ...
 * @cond    CAMERIC_FULL
 *
 * @brief   This function enable digital gain.
 *
 * @param   handle              CamerIc driver handle
 * @param   enable              enable the digital gain
 ...
 *
 * @param   handle              CamerIc driver handle
 * @param   pIsEnabled              enable the digital gain
 ...
 * @cond    CAMERIC_FULL
 *
 * @brief   This function get the digital gain module enable status..
 *
 * @param   handle              CamerIc driver handle
 * @param   pIsEnabled          pointer to the digital enable status.
...
/**
 *
 * @brief   This function set the digital gain module gain.
 *
 * @param   handle              CamerIc driver handle
 * @param   pDigiCfg          pointer to the digital config context.
...
/**
 *
 * @brief   This function get the digital gain module gain.
 *
 * @param   handle              CamerIc driver handle
 * @param   pDigiCfg          pointer to the digital config context.
