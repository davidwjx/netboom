...
IF EXIST "C:\PROGRA~1\7-Zip\7z.exe" (SET 7Z_RUN="C:\PROGRA~1\7-Zip\7z.exe") ELSE CALL :Find7Zip 7z.exe 7za.exe 7zan.exe
IF !7Z_RUN! EQU "" (
...
rem !7Z_RUN! a "!DRIVER_FILES_7Z!" !FILES_TO_PACK! !7Z_SWITCHES!
!7Z_RUN! a "!DRIVER_FILES_7Z!" !FILES_TO_PACK!
IF NOT "!ERRORLEVEL!" EQU "0" (
