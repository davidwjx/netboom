...
INU_USB_LIB_SRC_ROOT:=$(INU_USB_LIB_ROOT)/src
...
LOCAL_SRC_FILES := \
	$(INU_USB_LIB_SRC_ROOT)/inu_boot.c \
	$(INU_USB_LIB_SRC_ROOT)/inu_monitor.c \
	$(INU_USB_LIB_SRC_ROOT)/inu_usb_libusb.c \
	$(INU_USB_LIB_SRC_ROOT)/inu_bootdetect.c \
