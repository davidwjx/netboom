...
#define PRODUCTION_EXT_STRING_SIZE		(40)
...
typedef enum
 {
   ...
   INU_STORAGE_SECTION_DYNAMIC_CALIBRATION = 4,
   INU_STORAGE_SECTION_BOOTSPL             = 5,
   INU_STORAGE_SECTION_DTB                 = 6,
   INU_STORAGE_SECTION_KERNEL              = 7,
   INU_STORAGE_SECTION_ROOTFS              = 8,
   INU_STORAGE_SECTION_CEVA                = 9,
   INU_STORAGE_SECTION_CNN_LD              = 10,
   INU_STORAGE_SECTION_CNN                 = 11,
   INU_STORAGE_SECTION_APP                 = 12
...
typedef struct 
{   
    unsigned int extKey; // 0xabcd1234
