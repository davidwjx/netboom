...
#define SECTION_CALIBRATION_AUTO_SIZE_INCREASE  (30)
	...
	//INU_STORAGE_SECTION_CALIBRATION_DATA
#define SECTION_DYN_CALIBRATION_MAGIC_NUMBER    (0x87654332)
#define SECTION_DYN_CALIBRATION_VERSION_NUMBER      (0x100)
#define SECTION_DYN_CALIBRATION_START_BLOCK         (SECTION_START_BLOCK_LAST)
#define SECTION_DYN_CALIBRATION_SIZE_IN_BLOCKS      (SECTION_SIZE_DYNAMIC)
#define SECTION_DYN_CALIBRATION_AUTO_SIZE_INCREASE  (30)
...
//INU_STORAGE_SECTION_CNN_DATA
#define SECTION_CNN_DATA_MAGIC_NUMBER           (0x87654331)
#define SECTION_CNN_DATA_VERSION_NUMBER         (0x100)
#define SECTION_CNN_DATA_START_BLOCK            (4)
#define SECTION_CNN_DATA_SIZE_IN_BLOCKS         (SECTION_SIZE_DYNAMIC)
#define SECTION_CNN_DATA_AUTO_SIZE_INCREASE     (0)
...
#define FW_UPDATE_FROM_ACTIVE_PARTITION  (0xcafedea1)
#define FW_UPDATE_FROM_BACKUP_PARTITION  (0xc0cac01a)
...
typedef struct
{
	unsigned int extKey;
	// Unique ID of each sensor
	char serialNumber[PRODUCTION_EXT_STRING_SIZE];
	// General operational data
	char modelNumber[PRODUCTION_STRING_SIZE];
	char partNumber[PRODUCTION_STRING_SIZE];
	char sensorRevision[PRODUCTION_STRING_SIZE];
...
typedef struct
{
	...
	// Size of InuSecurityHeaderT must be 8 Bytes
