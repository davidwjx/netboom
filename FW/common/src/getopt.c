...
int getopt(
     ...
     char *optstring)
{
  return _getopt_internal(argc, (char *const *)argv, (const char *)optstring, (const struct option *) 0,
                          (int *) 0, 0);
}
...
int getopt_long(
     ...
     int *opt_index)
{
  return _getopt_internal(argc, (char *const *)argv, (const char *)options, (const struct option *)long_options, opt_index, 0);
}
...
int getopt_long_only(
     ...
     int *opt_index)
{  
  return _getopt_internal(argc, (char *const *)argv, (const char *)options, (const struct option *)long_options, opt_index, 1);
}
