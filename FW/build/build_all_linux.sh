CURRENT_DIR=$(pwd)
INU=/opt/Inuitive/InuDev/bin/nu4100/boot0
...
cd ../nu4100/app/build/host/
chmod +x bin/nu4100/target/boot0/targetfs/* 
chmod +x bin/nu4100/target/boot0/gp/inu_target.out.nonstripped
cp bin/linux_gcc-7.4_x86_64/* /opt/Inuitive/InuDev/bin/
./build.sh -p  ./build.sh -p linux_gcc-7.4_x86_64
cp -av bin/linux_gcc-7.4_x86_64/* $INU/../../
