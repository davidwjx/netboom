...
//
// Inuitive fix: 
// fixed  *get_temporary_path() *names[] variable to use different paths on android (line 409)
//
// See http://www.boost.org/libs/interprocess for documentation.
//
//
...
#include "BoostFix/win32_api.hpp"  // Should be second
#include "BoostFix/shared_dir_helpers.hpp"
#else
...
#elif __ANDROID__
    const char *names[] = {"/storage/emulated/0/Inuitive", "TMPDIR", "TMP", "TEMP" };
#else
