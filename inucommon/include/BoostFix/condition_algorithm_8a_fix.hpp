...
//
// Inuitive fix:
// Add timeout in line 258  data.get_sem_block_lock().timed_wait(abs_time);
// Avoids infinite deadlock when the MessageQueue closes incorrectly
//
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
   ...
   )
{
   ...
   bool bTimedOut = tout_enabled 
       ? !data.get_sem_block_lock().timed_wait(abs_time)
       : (data.get_sem_block_lock().wait(), false);
