...
//
// Inuitive fix:
// Use spinlock with timeout - line 97
//
//////////////////////////////////////////////////////////////////////////////
...
namespace boost {
   ...
   { return m_condition.notify_one(abs_time);  } //Inuitive add timed notification

   //!Change the state of all threads waiting on *this to ready.
   //!If there are no waiting threads, notify_all() has no effect.
   bool notify_all(const boost::posix_time::ptime &abs_time)
   { return m_condition.notify_all(abs_time);  } //Inuitive add timed notification
