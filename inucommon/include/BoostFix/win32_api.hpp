...
//  
//  Patch was taken from https://svn.boost.org/trac/boost/ticket/11480
//
//////////////////////////////////////////////////////////////////////////////
...
inline bool get_last_bootup_time(std::string &stamp)
{
   ...
   sprintf_s(&stamp_str[0], sizeof(unsigned long long) * 3 + 1, "%llu", std::time(nullptr) - GetTickCount64() / 1000); // Seconds since 1-1-1970
   stamp = stamp_str;
