...
#pragma warning(default : 4251)
        ...
        static bool    putenv(const std::string& varname, const std::string& value);
        ...
        /// \brief Configure the application to work with OpenMP
        /// \param[in] argv       argv of the current application
        /// \return bool        success/fail
        static bool ConfigureOMP(char* const* argv);
