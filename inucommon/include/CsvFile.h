...
namespace InuCommon
{
    ...
    public:
        ...
        static EError ReadWithoutSpaces(const std::string& iFileName, std::vector<std::vector<std::string>>& oBuffer, std::string& oRevision);
        ...
        /// \param[out]  oRevision   Revision of output file.
        /// \return EError    eOK in case of success.
        static EError Read(const std::string& iFileName, std::vector<std::vector<std::string>>& oBuffer, std::string& oRevision);
...
#pragma warning(suppress : 4251)
        ...
        /// \param[out]  oRevision   Revision of output file.
        /// \return EError    eOK in case of success.
        static EError Read(const std::string& iFileName, std::vector<std::vector<std::string>>& oBuffer, const bool iTrimLine, std::string& oRevision);
    };
}
