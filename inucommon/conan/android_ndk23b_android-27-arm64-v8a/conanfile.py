...
class InuCommonConan(ConanFile):
    name = "inucommon_android_ndk23b_android-27-arm64-v8a"
    ...
    description = "Conan recipe for InuCommon for Android ndk23b"
    ...
    def package(self):
        ...
        self.copy("*", dst="bin", src="bin/android_ndk23b_android-27-arm64-v8a")
